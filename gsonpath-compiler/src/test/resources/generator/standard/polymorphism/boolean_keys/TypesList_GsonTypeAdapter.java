...
public final class TypesList_GsonTypeAdapter extends TypeAdapter<TypesList> {
    ...
    private static final class ItemsGsonSubtype extends TypeAdapter<Type> {
        ...
        private ItemsGsonSubtype(Gson gson) {
            ...
            typeAdaptersDelegatedByValueMap.put(true, gson.getAdapter(generator.standard.polymorphism.Type1.class));
            ...
            typeAdaptersDelegatedByValueMap.put(false, gson.getAdapter(generator.standard.polymorphism.Type2.class));
