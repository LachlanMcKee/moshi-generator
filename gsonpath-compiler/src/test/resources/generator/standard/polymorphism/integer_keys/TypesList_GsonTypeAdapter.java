...
public final class TypesList_GsonTypeAdapter extends TypeAdapter<TypesList> {
    ...
    private static final class ItemsGsonSubtype extends TypeAdapter<Type> {
        ...
        private ItemsGsonSubtype(Gson gson) {
            ...
            typeAdaptersDelegatedByValueMap.put(0, gson.getAdapter(generator.standard.polymorphism.Type1.class));
            ...
            typeAdaptersDelegatedByValueMap.put(1, gson.getAdapter(generator.standard.polymorphism.Type2.class));
