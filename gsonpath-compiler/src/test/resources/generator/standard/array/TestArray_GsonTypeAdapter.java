                ...
                case "test1":
                    ...
                    while (in.hasNext()) {
                        switch (test1_arrayIndex) {
                            case 1:
                                Integer value_test1_1_ = getIntegerSafely(in);
                                ...
                                while (in.hasNext()) {
                                    ...
                                    switch (in.nextName()) {
                                        case "child":
                                            ...
                                            Integer value_test2_2__child = getIntegerSafely(in);
                                        ...
                                        case "child2":
                                            ...
                                            Integer value_test2_2__child2 = getIntegerSafely(in);
                                        ...
                                        case "child":
                                            ...
                                            while (in.hasNext()) {
                                                switch (child_arrayIndex) {
                                                    case 1:
                                                        Integer value_test3_3__child_1_ = getIntegerSafely(in);
                        ...
                        switch (in.nextName()) {
                            case "child":
                                ...
                                while (in.hasNext()) {
                                    switch (child_arrayIndex) {
                                        case 1:
                                            Integer value_test4_child_1_ = getIntegerSafely(in);
