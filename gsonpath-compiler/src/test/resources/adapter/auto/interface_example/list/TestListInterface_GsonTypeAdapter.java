...
public final class TestListInterface_GsonTypeAdapter extends TypeAdapter<TestListInterface> {
    ...
    public TestListInterface read(JsonReader in) throws IOException {
        ...
        if (value_internalList_safe != null) {
            ...
            throw new gsonpath.JsonFieldMissingException("Mandatory JSON element 'internalList' was null for class 'adapter.auto.interface_example.list.TestListInterface_GsonPathModel'");
        }
        ...
        for (int mandatoryFieldIndex = 0; mandatoryFieldIndex < MANDATORY_FIELDS_SIZE; mandatoryFieldIndex++) {
            ...
            if (!mandatoryFieldsCheckList[mandatoryFieldIndex]) {
                ...
                throw new gsonpath.JsonFieldMissingException("Mandatory JSON element '" + fieldName + "' was not found for class 'adapter.auto.interface_example.list.TestListInterface_GsonPathModel'");
            }
        }
