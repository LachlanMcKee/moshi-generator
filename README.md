...
```gradle
compile 'net.lachlanmckee:gsonpath:3.8.0'
apt 'net.lachlanmckee:gsonpath-compiler:3.8.0'

compile 'net.lachlanmckee:gsonpath-kt:3.8.0' // an optional Kotlin library 
```
