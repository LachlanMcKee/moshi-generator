...
```gradle
compile 'net.lachlanmckee:gsonpath:3.6.0'
apt 'net.lachlanmckee:gsonpath-compiler:3.6.0'

compile 'net.lachlanmckee:gsonpath-kt:3.6.0' // an optional Kotlin library 
```
