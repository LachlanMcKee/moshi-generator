package gsonpath.generator.standard.extension.gsonSubType;
...
public class GsonSubTypeTest {
    ...
    public void givenNullTypeField_whenReadingJson_thenExpectException() {
        ...
        try {
            ...
            Assert.assertEquals("cannot deserialize gsonpath.generator.standard.extension.gsonSubType.Type because the subtype field 'type' is either null or does not exist.", e.getMessage());
            return;
        }
